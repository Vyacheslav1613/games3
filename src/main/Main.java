...
class Main{
    public static void main(String[] args) throws IOException {
        ...
        openZIP(ZIP, gamePathFolder);
        openGameProgress(gamePath3);
    }

    private static void openGameProgress(String gamePath) {
        GameProgress gameProgress = null;
        try (FileInputStream fis = new FileInputStream(gamePath);
    ...
    private static void openZIP(String zip, String gamePathFolder) {
        try (FileInputStream fileInputStream = new FileInputStream(zip);
            ...
            while (zipEntry != null) {
                ...
                File outputFile = new File(gamePathFolder, fileName);
